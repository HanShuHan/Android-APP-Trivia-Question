...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Lab 2-6: Image Views
        myImageView.setOnClickListener(v -> Toast.makeText(this, "You just clicked the: " + v.getId(), Toast.LENGTH_SHORT).show());
        myImageBtn.setOnClickListener(v -> Toast.makeText(this, "The width = " + v.getWidth() + " and height = " + v.getHeight(), Toast.LENGTH_SHORT).show());
    }
}